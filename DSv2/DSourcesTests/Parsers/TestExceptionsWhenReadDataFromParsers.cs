...
{
    [TestClass]
    public class TestExceptionsWhenReadDataFromParsers
    {
        ...
        [TestCategory("Odczyt__żródła__danych")]
        [TestCategory("ACCEPTANCE")]
        public void Odczyt_z_CSV()
        {
        ...
        [TestCategory("Odczyt__żródła__danych")]
        [TestCategory("ACCEPTANCE")]
        public void Odczyt_z_bazy_MySQL()
        {
            ParserConfiguration.Builder builder = ParserConfiguration.GetBuilder();
        ...
        [TestCategory("Odczyt__żródła__danych")]
        [TestCategory("ACCEPTANCE")]
        public void Odczyt_z_bazy_MSSQL()
        {
            ParserConfiguration.Builder builder = ParserConfiguration.GetBuilder();
        ...
        [TestCategory("WyjątekCzytania")]
        public void Odczyt_z_bazy_MongoDB()
        {
            ParserConfiguration.Builder builder = ParserConfiguration.GetBuilder();
            ...
            builder.SetProperty(MongoDBParser.FIELD_NAMES_KEY, "Region, Rep, Iem, Units, Cost, Total");
        ...
        [TestCategory("Odczyt__żródła__danych")]
        [TestCategory("ACCEPTANCE")]
        public void Odczyt_z_bazy_PostreSQL()
        {
            ParserConfiguration.Builder builder = ParserConfiguration.GetBuilder();
            ...
            builder.SetProperty(PostgreSQLParser.REQUEST_KEY, "selct region, rep, item, units, cost, total from sampledata");
